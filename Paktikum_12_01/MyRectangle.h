...
class MyRectangle
{
	...
	friend class MyFilledRectangle;
...
public:
	...
	void set_x1(int new_x1) { x1 = new_x1; }
	void set_y1(int new_y1) { y1 = new_y1; }
	void set_x2(int new_x2) { x2 = new_x2; }
	void set_y2(int new_y2) { y2 = new_y2; }
	void draw();
